...
namespace Lyranetwork\Micuentaweb\Sdk\Refund;
...
class Api {
     ...
     *
     * @param \Lyranetwork\Micuentaweb\Sdk\Refund\Processor $refundProcessor
     ...
     * Refund money.
     *
     * @param \Lyranetwork\Micuentaweb\Sdk\Refund\OrderInfo $orderInfo
     * @param float $amount
     */
    ...
    {
        /**
         * @var Lyranetwork\Micuentaweb\Sdk\Rest\Api $client
         * */
    ...
    private function checkRestResult($response, $expectedStatuses = array())
    {
        ...
        if ($response['status'] !== 'SUCCESS') {
            ...
            throw new \Lyranetwork\Micuentaweb\Sdk\Refund\WsException($errorMessage, $answer['errorCode']);
