...
class Cartflows_Ca_Email_Schedule {
	...
	public function get_email_product_block( $cart_contents, $cart_total ) {
		...
		foreach ( $cart_items as $cart_item ) {
			...
			if ( isset( $cart_item['product_id'] ) && isset( $cart_item['quantity'] ) && isset( $cart_item['line_total'] ) ) {
				...
				$tr = $tr . '<tr align="center">
                           <td style="font-size: 14px;border-bottom: 1px solid #e5e1e1;"><img  class="demo_img" style="' . $product_image_style . '" src="' . esc_url( $image_url ) . '" ' . $style_filter['product_image']['attribute'] . '></td>
                           <td style="font-size: 14px;border-bottom: 1px solid #e5e1e1;">' . $product_name . '</td>
                           <td style="font-size: 14px;border-bottom: 1px solid #e5e1e1;"> ' . $cart_item['quantity'] . ' </td>
                           <td style="font-size: 14px;border-bottom: 1px solid #e5e1e1;">' . wc_price( $cart_item['line_total'] ) . '</td>
                           <td style="font-size: 14px;border-bottom: 1px solid #e5e1e1;" >' . wc_price( $cart_item['line_total'] ) . '</td>
                        </tr> ';
			}
		}
		...
		return '<table ' . $style_filter['table']['attribute'] . ' cellpadding="10" cellspacing="0" style="background-color: #fff;border: 1px solid #e5e1e1;margin-top: 24px;">
	                <tr align="center" style="background-color: #213236;color: #fff;">
	                   <th  style="font-size: 14px;text-transform: uppercase;FONT-WEIGHT: 600;">' . __( 'Item', 'woo-cart-abandonment-recovery' ) . '</th>
	                   <th  style="font-size: 14px;text-transform: uppercase;FONT-WEIGHT: 600;">' . __( 'Name', 'woo-cart-abandonment-recovery' ) . '</th>
	                   <th  style="font-size: 14px;text-transform: uppercase;FONT-WEIGHT: 600;">' . __( 'Quantity', 'woo-cart-abandonment-recovery' ) . '</th>
	                   <th  style="font-size: 14px;text-transform: uppercase;FONT-WEIGHT: 600;">' . __( 'Price', 'woo-cart-abandonment-recovery' ) . '</th>
	                   <th  style="font-size: 14px;text-transform: uppercase;FONT-WEIGHT: 600;">' . __( 'Line Subtotal', 'woo-cart-abandonment-recovery' ) . '</th>
	                </tr> ' . $tr . '
	        </table>';
	}
