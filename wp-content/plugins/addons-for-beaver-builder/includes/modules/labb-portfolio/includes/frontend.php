...
if ($loop->have_posts()) :
    ...
    $chosen_taxonomy = $settings->taxonomy_filter;
        ...
        if ($thumbnail_exists = has_post_thumbnail()):
            ...
            if (($settings->display_title_on_thumbnail == 'yes') || ($settings->display_taxonomy_on_thumbnail == 'yes')):
                ...
                if ($settings->display_title_on_thumbnail == 'yes'):
                    ...
                    $image_info .= '<' . $settings->thumbnail_info_title_tag . ' class="labb-post-title"><a href="' . get_permalink() . '" title="' . get_the_title() . '" rel="bookmark"' . $target . '>' . get_the_title() . '</a></' . $settings->thumbnail_info_title_tag . '>';
