    ...
    function woocommerce_confirmo_init()
    {
        ...
        class WC_Confirmo_Gateway extends WC_Payment_Gateway
        {
            ...
            function __construct()
            {
                ...
                $this->title = "Confirmo: Pago con criptomonedas"; // title of the payment method (can be overridden by the user)
                // This controls the description which the user sees during checkout.
                $this->description = "Cuando realices el pedido serás redireccionado a la web de Confirmo donde podrás verificar el total de tu compra y seleccionar la criptomoneda de tu preferencia. Al hacerlo se generará un QR y una dirección a la cual transferir el monto, asegúrate de incluir la comisión en caso la hubiera. <br><br><img style='margin-left: 0; margin-right: 5px;' width='16px' height='16px' src='https://tiendakrear3d.com/wp-content/uploads/2023/07/info1.webp'> Recuerda que tienes 15 minutos para realizar el pago, de lo contrario tendrás que repetir el proceso.";
