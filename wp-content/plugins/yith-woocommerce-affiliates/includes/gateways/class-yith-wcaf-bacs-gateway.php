		...
		protected function init_fields() {
			$this->fields = array(
				'bacs_name'  => array(
					 ...
					 */
					'label'   => apply_filters( 'yith_wcaf_account_name_label', _x( 'Numero de cuenta', '[ADMIN] PayPal gateway affiliate settings.', 'yith-woocommerce-affiliates' ) ),
					'type'    => 'text',
				...
				'bacs_iban'  => array(
					 ...
					 * @param string $label Field label.
					 */
					'label'   => apply_filters( 'yith_wcaf_iban_label', _x( 'CCI', '[ADMIN] PayPal gateway affiliate settings.', 'yith-woocommerce-affiliates' ) ),
					'type'    => 'text',
				...
				'bacs_swift' => array(
					 ...
					 * @param string $label Field label.
					 */
					'label'   => apply_filters( 'yith_wcaf_swift_code_label', _x( 'Banco y Tipo de cuenta (Ejm. BCP-Ahorro)', '[ADMIN] PayPal gateway affiliate settings.', 'yith-woocommerce-affiliates' ) ),
					'type'    => 'text',
